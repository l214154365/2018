...
<html>
 ...
 var F_id;
	...
	if(val=="1"){
     nav_id=Number(node.nav_id)+1;
	 parent_id=0;
     F_id=0;
	}else{
	   nav_id=0;
	   parent_id=node.nav_id;
	   F_id=node.Id;
	}
	}else{
	   nav_id=0;
        ...
        <div class="span10">
          ...
          <hr style="border:1px solid black;"/>
              ...
              <label>
               ...
               <div>
                      <span class="smallname">菜单名称:<input type="text" id="menuname"></span> 
                </div>      
               
                       <label>
                       <input type="radio" name="f_s" value="1"  class="a-radio">
                       <span class="b-radio"></span>同级
                       </label>
                       <label>
                       <input type="radio" name="f_s" value="2"  class="a-radio">
                       <span class="b-radio"></span>父子
                       </label>
